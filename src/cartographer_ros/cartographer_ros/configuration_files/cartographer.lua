...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.translation_delta_cost_weight = 8
...
POSE_GRAPH.constraint_builder.global_localization_min_score = 1.90
POSE_GRAPH.optimization_problem.huber_scale = 500
POSE_GRAPH.optimize_every_n_nodes = 30
POSE_GRAPH.constraint_builder.max_constraint_distance = 4
POSE_GRAPH.global_constraint_search_after_n_seconds = math.huge

--some riscy shit for disabling global connections
